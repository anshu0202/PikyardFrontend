...
// Set the token in a cookie called "token" that will expire in 7 days
...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    if(data){
      ...
      // console.log("login cartItems are userAction", cartItems)
...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.post(`${API_BASE_URL}/api/v2/registration`, userData, config);
...
export const loadUser = () => async (dispatch) =>{
  try {
      ...
      // const {data} = await axios.get(`${API_BASE_URL}/api/v2/me`);
...
export const logout = () => async (dispatch) =>{
  try {        
    // await axios.get(`${API_BASE_URL}/api/v2/logout`);
...
export const updateProfile = (userData) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.put(`${API_BASE_URL}/api/v2/me/update/info`, userData, config);
...
export const updatePassword = (password) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.put(`${API_BASE_URL}/api/v2/me/update`, password, config);
...
export const getAllUsers = () => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(`${API_BASE_URL}/api/v2/admin/users`);
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.post(`${API_BASE_URL}/api/v2/password/forgot`, email, config);
...
export const resetPassword = (token, passwords) => async (dispatch) => {
  try {
    ...
    //   `${API_BASE_URL}/api/v2/password/reset/${token}`,
    //   passwords,
    //   config
    // );
...
export const deleteUser = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.delete(`${API_BASE_URL}/api/v2/admin/user/${id}`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    // const { data } = await axios.get(`${API_BASE_URL}/api/v2/admin/user/${id}`);
...
export function updateUser(id, userData) {
  return async (dispatch) => {
    try {
      ...
      // const { data } = await axios.put(
      //   `${API_BASE_URL}/api/v2/admin/user/${id}`,
      //   userData,
      //   config
      // );
      const { data } = await axios.put(
